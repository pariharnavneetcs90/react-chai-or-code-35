                ...
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    ...
                    >
                        <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                            ...
                            <li>
                                <NavLink
                                    //call back me iss liye likha hai kyo ki isActive use kar sake taki nav me pata chal jaye home me hai ki about me 
                                    className={({ isActive }) =>
                                        //// ${isActive ? text-orange-700 : text-gray-700} --- active hai to orange nahi to gray
